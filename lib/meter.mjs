...
/**
 * What a verified demo account gets.
 *
 * The public trial is ten CVs, which is enough to judge the output and not
 * enough to run a desk on — deliberately, per decision 004. Someone who sat
 * through a demo and confirmed a work address is a different proposition: the
 * thing you want them to do is put a week of their actual shortlist through it,
 * and ten CVs will not let them. Fifty is enough to form a habit and still well
 * under what an agency gets through in a month.
 *
 * This is the reason to click the link. An account that unlocks nothing is a
 * form nobody completes.
 */
export const DEMO_TOTAL = 50;
export const DEMO_PER_DAY = 25;
